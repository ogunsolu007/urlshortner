    ...
    <>
      <header className="header max-width py-5">
        <div className="flex items-center justify-between">
          ...
          {isOpen && (
            <div
              className="absolute left-5 right-5 rounded bg-slate-900 text-slate-200 
            top-20 text-center py-10
            md:relative md:top-0 md:left-0 md:right-0 md:bg-transparent md:text-slate-700
            md:text-left md:py-0 md:flex md:items-center
            "
            >
          ...
          <button
            ...
            className="uppercase text-sm tracking-wide md:hidden lg:hidden"
          >
            {isOpen ? "Close" : "Menu"}
          </button>
        </div>
